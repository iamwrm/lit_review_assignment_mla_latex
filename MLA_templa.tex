...
In service industry, communication means that the service providers reciece the
...
angry about that unsuccessful communication and then tell others not to use the
